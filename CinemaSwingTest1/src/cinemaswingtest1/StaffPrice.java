...
public class StaffPrice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setText("RM10.00");
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 220, 220, 50));

        jTextField3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jTextField3.setText("RM17.00");
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 310, 220, 50));
        ...
        jTextField1.setText("RM25.00");
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 400, 220, 50));
